...
### Todo 2: <MongoDb> Create a Database(tas invite mo kami) in MongoDB, name the database BooksDB, and add a collection name it items.
...
### Todo 5: Create a deleteItem() for deleting items from the database(Simple lang din saka na yung may kasamang table).
### Todo 6: Create a editItem() for editing a row info from the database.
### Todo 7: Create a sortItems() to sort, by name, or date.
### Todo 8: Add a feature na pwedeng magsearch ng item.
### Todo 9: Tapusin na natin to guys katamad gumawa ng TODOs HAHAHAHA.
